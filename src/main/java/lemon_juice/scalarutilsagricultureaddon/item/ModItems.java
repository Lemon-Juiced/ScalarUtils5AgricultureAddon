...
public class ModItems {
    ...
    public static final RegistryObject<Item> QUARTZ_ENRICHED_IRON_SEEDS = ITEMS.register("quartz_enriched_iron_seeds", () -> new AbstractBaseSeedItem(ModBlocks.QUARTZ_ENRICHED_IRON_CROP.get(), new Item.Properties(), 2));
    ...
    public static final RegistryObject<Item> REDSTONE_ALLOY_SEEDS = ITEMS.register("redstone_alloy_seeds", () -> new AbstractBaseSeedItem(ModBlocks.REDSTONE_ALLOY_CROP.get(), new Item.Properties(), 3));public static final RegistryObject<Item> RIDICULITE_SEEDS = ITEMS.register("ridiculite_seeds", () -> new AbstractBaseSeedItem(ModBlocks.RIDICULITE_CROP.get(), new Item.Properties(), 3));
